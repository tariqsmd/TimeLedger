                ...
                return (
                    <section className={styles.tabContent}>
                        ...
                        <div className={styles.sectionHeader} style={{ marginTop: '3rem' }}>
                            <h3 className={styles.sectionTitle}>Sample Data</h3>
                            <p className={styles.sectionDesc}>Populate your workspace with example content to test features.</p>
                        </div>
                        <button className={styles.btnPrimary} onClick={loadSampleData}>
                            Load Sample Data
                        </button>
                    </section>
                );
